...
public class Baloon extends Aircraft implements Flyable {
	...
	public void updateConditions() {
		...
		switch(weather) {
			...
			case "FOG":
				...
				WriteFile.writeF("Baloon#" + name + "(" + Baloon.this.id + ")" +  ": Fog forecast you may not have the full experience of the trip/tour.");
				break;
			case "SUN":
				...
				WriteFile.writeF("Baloon#" + name + "(" + Baloon.this.id + ")" +  ": Sunny Day enjoy the fantastic view while you can.");
				break;
			case "SNOW":
				...
				WriteFile.writeF("Baloon#" + name + "(" + Baloon.this.id + ")" +  ": Snow forecast stay close to the fire to keep warmth.");
				break;
		}
		if (this.coords.getHeight() <= 0) {
			//System.out.println("Baloon#" + name + "(" + Baloon.this.id + ")" +  ": Is now Landed.");
			WriteFile.writeF("Baloon#" + name + "(" + Baloon.this.id + ")" +  ": Is now Landed.");
			...
			WriteFile.writeF("Tower says: Baloon#" + name + "(" + Baloon.this.id + ")" + " unregistered to weather tower.");
		}
	}
	...
	public void registerTower(final WeatherTower weatherTower) {
		...
		WriteFile.writeF("Tower says: Baloon#" + name + "(" + Baloon.this.id + ")" + " registered to weather tower.");
	}
}